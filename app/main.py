...
def add_predictions(input_data):
    ...
    st.write("This app was made by me and is for informational purposes only. It is not a substitute for professional medical advice, diagnosis, or treatment. Always consult a healthcare professional for personalized medical guidance.")
...
def main():
    ...
    with st.container():
        st.title("Kevin's ML Breast Cancer Diagnosis")
        st.write("Connect this app to your cytology lab results to help diagnose breast cancer from your tissue sample. This app uses a machine learning model to predict whether your results are Benign or Malignant based on the breast mass measurements linked from your cytosis lab. You can also update the measurements manually using the sliders in the sidebar")
